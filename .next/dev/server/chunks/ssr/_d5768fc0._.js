...
function ProductsContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchProducts() {
            setLoading(true);
            // Base Query
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('products').select('*, category:categories(name)');
            ...
            if (data) {
                ...
                if (selectedCategory !== "All") {
                    mappedProducts = mappedProducts.filter((p)=>p.category === selectedCategory);
                }
                // 2. Age Group
                if (selectedAge) {
                    mappedProducts = mappedProducts.filter((p)=>p.ageGroup && p.ageGroup.includes(selectedAge));
                }
                // 3. Sale Items Only
                if (showSaleOnly) {
                    mappedProducts = mappedProducts.filter((p)=>p.originalPrice && p.price < p.originalPrice);
                }
...
//# sourceMappingURL=_d5768fc0._.js.map