...
async function POST(request) {
    try {
        ...
        // 2. Create Order
        const { data: order, error: orderError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('orders').insert({
        ...
        const { error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('order_items').insert(orderItems);
        if (itemsError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a901ff1b._.js.map