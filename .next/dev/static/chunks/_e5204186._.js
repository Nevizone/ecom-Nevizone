...
function ProductsContent() {
    ...
    const [selectedAge, setSelectedAge] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [showSaleOnly, setShowSaleOnly] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductsContent.useEffect": ()=>{
            async function fetchCategories() {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('categories').select('name');
                if (data) {
                    setCategoriesList([
                        "All",
                        ...data.map({
                            "ProductsContent.useEffect.fetchCategories": (c)=>c.name
                        }["ProductsContent.useEffect.fetchCategories"])
                    ]);
                }
            }
            fetchCategories();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductsContent.useEffect": ()=>{
            async function fetchProducts() {
                setLoading(true);
                // Base Query
                let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('products').select('*, category:categories(name)');
                ...
                if (data) {
                    // Map to UI Model
                    let mappedProducts = data.map({
                        "ProductsContent.useEffect.fetchProducts.mappedProducts": (p)=>({
                                id: p.id,
                                name: p.name,
                    ...
                    }["ProductsContent.useEffect.fetchProducts.mappedProducts"]);
                    // Client-side Filtering
                    // 1. Category
                    if (selectedCategory !== "All") {
                        mappedProducts = mappedProducts.filter({
                            "ProductsContent.useEffect.fetchProducts": (p)=>p.category === selectedCategory
                        }["ProductsContent.useEffect.fetchProducts"]);
                    }
                    // 2. Age Group
                    if (selectedAge) {
                        mappedProducts = mappedProducts.filter({
                            "ProductsContent.useEffect.fetchProducts": (p)=>p.ageGroup && p.ageGroup.includes(selectedAge)
                        }["ProductsContent.useEffect.fetchProducts"]);
                    }
                    // 3. Sale Items Only
                    if (showSaleOnly) {
                        mappedProducts = mappedProducts.filter({
                            "ProductsContent.useEffect.fetchProducts": (p)=>p.originalPrice && p.price < p.originalPrice
                        }["ProductsContent.useEffect.fetchProducts"]);
                    }
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: categoriesList.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(ProductsContent, "krqzabwl+MnNjR+aA2sypPcBccU=", false, function() {
    return [
...
//# sourceMappingURL=_e5204186._.js.map